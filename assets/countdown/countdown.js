    ...
    function t(a, c, f, d, e, k) {
      ...
      try {
        ...
        if (0 > a.milliseconds) {
          ...
          1e3 <= a.milliseconds &&
            ((a.seconds += n(a.milliseconds / 1e3)), (a.milliseconds %= 1e3));
        0 > a.seconds
          ? ((q = r(-a.seconds / 60)), (a.minutes -= q), (a.seconds += 60 * q))
          : 60 <= a.seconds &&
            ((a.minutes += n(a.seconds / 60)), (a.seconds %= 60));
        0 > a.minutes
          ? ((q = r(-a.minutes / 60)), (a.hours -= q), (a.minutes += 60 * q))
          : 60 <= a.minutes &&
            ((a.hours += n(a.minutes / 60)), (a.minutes %= 60));
        0 > a.hours
          ? ((q = r(-a.hours / 24)), (a.days -= q), (a.hours += 24 * q))
          : 24 <= a.hours && ((a.days += n(a.hours / 24)), (a.hours %= 24));
        for (; 0 > a.days; ) a.months--, (a.days += b(a.refMonth, 1));
        7 <= a.days && ((a.weeks += n(a.days / 7)), (a.days %= 7));
        0 > a.months
          ? ((q = r(-a.months / 12)), (a.years -= q), (a.months += 12 * q))
          : 12 <= a.months && ((a.years += n(a.months / 12)), (a.months %= 12));
        10 <= a.years &&
          ((a.decades += n(a.years / 10)),
          (a.years %= 10),
          10 <= a.decades &&
            ((a.centuries += n(a.decades / 10)),
            (a.decades %= 10),
            10 <= a.centuries &&
              ((a.millennia += n(a.centuries / 10)), (a.centuries %= 10))));
        c = 0;
        !(d & 1024) || c >= e
        ...
        if (!(d & 1) || c >= e) {
          ...
          if (
            m &&
            (m = l(a, m, "seconds", "minutes", 60, k)) &&
            (m = l(a, m, "minutes", "hours", 60, k)) &&
            (m = l(a, m, "hours", "days", 24, k)) &&
            (m = l(a, m, "days", "weeks", 7, k)) &&
            (m = l(a, m, "weeks", "months", g(a.refMonth) / 7, k))
          ) {
            d = m;
            var A = a.refMonth,
              p = A.getTime(),
            ...
            if ((m = l(a, d, "months", "years", E / g(a.refMonth), k)))
              if ((m = l(a, m, "years", "decades", 10, k)))
                if ((m = l(a, m, "decades", "centuries", 10, k)))
                  if ((m = l(a, m, "centuries", "millennia", 10, k)))
    ...
    if (d)
      for (var e = 0, k = d.length; e < k; ++e) {
        ...
        DIRECTIVE_KEY_MAP.hasOwnProperty(l) &&
          ((n = DIRECTIVE_KEY_MAP[l]), (n = Number(b[n])));
        null !== n &&
          ("!" === h && (n = pluralize(r, n)),
          "" === h && 10 > n && (n = "0" + n.toString()),
          (g = g.replace(t, n.toString())));
      }
    return (g = g.replace(/%%/, "%"));
  };
}
